...
'Objetivo: Transforma os arquivos gerados pela leitura dos usuários de cada transação em um só arquivo
'Data: 04/10/200148
...
set objReadFile = fs.OpenTextFile("C:\Users\GLB00156\Documents\00000\TCodes.csv")

Do while NOT objReadFile.AtEndOfStream
	arrStr         = Split(objReadFile.ReadLine,";")
	TCode	       = arrStr(0)

oFile = "C:\Users\GLB00156\Documents\00000\" & TCode
...
Set objFileToWrite = objFSO.OpenTextFile("C:\Users\GLB00156\Documents\00000\All_Tcodes.txt", 2)
